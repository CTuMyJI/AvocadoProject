...
type ActionsTypes = FollowSuccessActionType | UnfollowSuccessActionType | SetUsersActionType | SetCurrentPageActionType |
    SetUsersTotalCountActionType | ToggleIsLoadingActionType | ToggleFollowingProgressActionType
...
const _followUnfollowFlow = async (dispatch: DispatchType,
    id: number,
    apiMethod: any, actionCreator: (id: number) => FollowSuccessActionType | UnfollowSuccessActionType) => {
